...
public class ChatViewHolder extends RecyclerView.ViewHolder {
    ...
    @BindView(R.id.chat_item_profile_container_profile_image) ImageView imageViewProfile;
    @BindView(R.id.chat_item_profile_container_is_provider_image) ImageView imageViewIsProvider;
    //MESSAGE CONTAINER
    @BindView(R.id.chat_item_message_container) RelativeLayout messageContainer;
    //IMAGE SENDED CONTAINER
    @BindView(R.id.chat_item_message_container_image_sent_cardview) CardView cardViewImageSent;
    @BindView(R.id.chat_item_message_container_image_sent_cardview_image) ImageView imageViewSent;
    //TEXT MESSAGE CONTAINER
    @BindView(R.id.chat_item_message_container_text_message_container) LinearLayout textMessageContainer;
    @BindView(R.id.chat_item_message_container_text_message_container_text_view) TextView textViewMessage;
    //DATE TEXT
    @BindView(R.id.chat_item_message_container_text_view_date) TextView textViewDate;
    ...
    public ChatViewHolder(@NonNull View itemView) {
        ...
        colorCurrentUser = ContextCompat.getColor(itemView.getContext(), R.color.sender_color);
        colorRemoteUser = ContextCompat.getColor(itemView.getContext(), R.color.receiver_color);
    }
    ...
    public void updateWithMessage(Message message, String currentUserId, RequestManager glide){
        ...
        Boolean isCurrentUser = message.getId().equals(currentUserId);
